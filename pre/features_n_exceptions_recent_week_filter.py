...
n_exceptions_train = pd.read_csv(config['data']['features']['aug_train']['n_exceptions_recent_week'])
...
n_exceptions_train_filter.to_csv(config['data']['features']['aug_train']['n_exceptions_recent_week_filter'], index=False)
